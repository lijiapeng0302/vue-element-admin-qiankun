...
const apps = [
{
	name:'tcb-dashboard', //子应用的名称
	entry:'//localhost:8080',//子应用的域名
	container:'#vueContainer',//承载子应用的容器，在上面App.vue中定义
	activeRule:'/dashboard', // 被激活的子应用的路由
},
{
	name:'tcb-documentation', //子应用的名称
	entry:'//localhost:8081',//子应用的域名
	container:'#documentation',//承载子应用的容器，在上面App.vue中定义
	activeRule:'/documentation/index', // 被激活的子应用的路由
}
]
